...
class ArxivSource(BaseRetrievalSource):
    ...
    The source does not contain a fake arXiv implementation.

    An actual client can be injected later:

        ArxivSource(client=arxiv_client)
    ...
    This keeps external provider concerns outside the retrieval
    orchestration layer.
    """

    source_type = RetrievalSource.ARXIV
